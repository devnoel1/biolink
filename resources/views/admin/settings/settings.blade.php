...
<div class="row">
    <div class="mb-3 mb-xl-5 mb-xl-0 col-12 col-xl-3">
        ...
        <div class="nav flex-column nav-pills d-none d-xl-flex" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link active" href="#main" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-home fa-sm mr-1"></i> <?= language()->admin_settings->tab->main ?></a>
            <a class="nav-link" href="#links" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-link fa-sm mr-1"></i> <?= language()->admin_settings->tab->links ?></a>
            <a class="nav-link" href="#payment" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-dollar-sign fa-sm mr-1"></i> <?= language()->admin_settings->tab->payment ?></a>
            <a class="nav-link" href="#business" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-briefcase fa-sm mr-1"></i> <?= language()->admin_settings->tab->business ?></a>
            {{-- <a class="nav-link" href="#captcha" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-low-vision fa-sm mr-1"></i> {{ language()->admin_settings->tab->captcha }} </a> --}}
            <a class="nav-link" href="#ads" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-ad fa-sm mr-1"></i> <?= language()->admin_settings->tab->ads ?></a>
            <a class="nav-link" href="#socials" data-bs-toggle="pill" role="tab"><i class="fab fa-fw fa-instagram fa-sm mr-1"></i> <?= language()->admin_settings->tab->socials ?></a>
            <a class="nav-link" href="#smtp" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-mail-bulk fa-sm mr-1"></i> <?= language()->admin_settings->tab->smtp ?></a>
            <a class="nav-link" href="#custom" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-paint-brush fa-sm mr-1"></i> <?= language()->admin_settings->tab->custom ?></a>
            <a class="nav-link" href="#announcements" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-sm fa-bullhorn mr-1"></i> <?= language()->admin_settings->tab->announcements ?></a>
            <a class="nav-link" href="#email_notifications" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-bell fa-sm mr-1"></i> <?= language()->admin_settings->tab->email_notifications ?></a>
            <a class="nav-link" href="#webhooks" data-bs-toggle="pill" role="tab"><i class="fa fa-fw fa-sm fa-code-branch mr-1"></i> <?= language()->admin_settings->tab->webhooks ?></a>
        </div>
    </div>
    <div class="col">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ url('admin/website-settings', []) }}" method="post" role="form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="main">
                            ...
                            <div class="form-group">
                                ...
                                <select id="default_language" name="default_language" class="form-control form-control-lg">
                                    <?php foreach(\App\Core\Language::$languages as $value) echo '<option value="' . $value . '" ' . (settings()->default_language == $value ? 'selected="selected"' : null) . '>' . $value . '</option>' ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="default_theme_style" name="default_theme_style" class="form-control form-control-lg">
                                    <?php foreach(\App\Core\ThemeStyle::$themes as $key => $value) echo '<option value="' . $key . '" ' . (settings()->default_theme_style == $key ? 'selected="selected"' : null) . '>' . $key . '</option>' ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php if(!empty(settings()->logo)): ?>
                                    <div class="m-1">
                                        <img src="{{ asset('uploads/logo/'.settings()->logo) }}" class="img-fluid" style="max-height: 2.5rem;height: 2.5rem;" />
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <?php if(!empty(settings()->favicon)): ?>
                                    <div class="m-1">
                                        <img src="{{ asset('uploads/favicon/'.settings()->favicon) }}" class="img-fluid" style="max-height: 32px;height: 32px;" />
                                    </div>
                                    <div class="custom-control custom-checkbox my-2">
                        ...
                        <div class="tab-pane fade" id="socials">
                            ...
                            <?php foreach($admin_socails AS $key => $value): ?>
                                <div class="form-group">
                        ...
                        <div class="tab-pane fade" id="smtp">
                            ...
                            <div class="my-3">
                                <a href="admin/settings/testemail" class="btn btn-outline-info"><?= language()->admin_settings->button->test_email ?></a>
