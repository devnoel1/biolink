    ...
    public static function get_start_end_dates_new($start_date = null, $end_date = null) {
        ...
        if($start_date == $end_date) {
            ...
            $return['process'] = function($date) {
                $date = explode(' ', $date);
                return ((new \DateTime($date[0]))->setTime($date[1], 0)->setTimezone(new \DateTimeZone(Date::$timezone))->format('H A'));
            };
        }
        ...
        if($years_difference >= 2) {
            ...
            $return['process'] = function($date) {
                return ((new \DateTime())->setDate($date, 6, 1)->setTimezone(new \DateTimeZone(Date::$timezone))->format('Y'));
            };
        }
